...
import { getResearch, ResearchItem } from "@/services/research.firestore";
      ...
      <div className="container mx-auto px-6">
        ...
        <div className="max-w-6xl mx-auto space-y-12">
          {items.map((item) => (
            <div
              key={item.id}
              className="bg-gradient-hero rounded-3xl p-8 md:p-12 text-primary-foreground shadow-portfolio-lg"
            >
